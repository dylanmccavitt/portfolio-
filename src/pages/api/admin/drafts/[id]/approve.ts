...
import { approveAdminDraftForPublish, type AdminPublishQueryable } from '@/lib/admin/publish';
import {
  readAdminAuthConfig,
  requireAdminSession,
  requireSameOrigin,
...
export interface AdminDraftApproveHandlerDeps {
...
function authorizeAdmin(
  request: Request,
  deps: AdminDraftApproveHandlerDeps,
...
export const POST = createAdminDraftApprovePostHandler();
export const ALL: APIRoute = () => adminJson(405, { ok: false, code: 'method_not_allowed', message: 'Use POST.' });
