/**
 * Canvas UI glitch engine (vendored from the prototype lab, engine only —
 * the React wrapper is unused because SnapshotFx feeds it). Renders a
 * sliced/RGB-split corruption of a source canvas onto an output canvas.
 * With `interval: 0` the corruption runs constantly; CSS decides when the
 * output is visible. Honors prefers-reduced-motion by holding the
 * envelope at zero.
 */
