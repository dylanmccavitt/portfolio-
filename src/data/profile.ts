...
const PROFILE_SOURCE = [
  ...
  },
  {
    ...
    summary:
      'This site is a fully static Astro build with one interactive React island for the homepage: every page prerenders, there is no database, and all content comes from a single typed catalog file in the repo. Dylan designed and built it with his own agentic workflow: heavy upfront planning, dozens of disposable design prototypes walked through in a real browser before locking a direction, and the finished design ported into production with automated tests and full no-JavaScript fallbacks. Deploying is the entire publish step.',
    publicationStatus: 'published',
    visibility: 'public',
  },
  {
