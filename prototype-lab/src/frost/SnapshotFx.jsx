...
/**
 * Feed content-sampling canvasui engines (Glitch, RetroDither, Letterpress)
 * in stock Chrome, where drawElementImage doesn't exist. The engines probe
 * their source canvas for `getContext("2d").drawElementImage` and
 * `requestPaint`; both are shimmed here so the engine takes its native
 * path, and "drawElementImage" blits a rasterized SVG-foreignObject
 * snapshot of the content instead (the same technique as the site
 * Shatter's snapshot tier). TEXT CONTENT ONLY — external <img> elements
 * don't survive foreignObject rasterization.
 */
